...
public class AdminCalendarDAO extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... strings) {
        try {
            String str;
            URL url = new URL("http://117.17.142.207:80/dbtest/AdminCalendar.jsp");//보낼 jsp 주소를 ""안에 작성합니다. (학교에서)
            ...
            sendMsg ="calendar_date="+strings[0]+"&store_name="+strings[1];
