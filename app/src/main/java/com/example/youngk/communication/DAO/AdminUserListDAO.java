...
public class AdminUserListDAO extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... strings) {
        try {
            String str;
            URL url = new URL("http://117.17.142.207:80/dbtest/AdminUserList.jsp");//보낼 jsp 주소를 ""안에 작성합니다. (학교에서)
            //URL url = new URL("http://192.168.123.167:8081/dbtest/login.jsp");//보낼 jsp 주소를 ""안에 작성합니다. (학교에서)
            // URL url = new URL("http://192.168.0.42:8081/dbtest/board.jsp");//보낼 jsp 주소를 ""안에 작성합니다. (학교에서)
