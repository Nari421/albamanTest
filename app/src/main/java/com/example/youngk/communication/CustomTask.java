...
public class CustomTask extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... strings) {
        try {
            String str;
            URL url = new URL("http://117.17.142.207:80/dbtest/dbdb.jsp");//보낼 jsp 주소를 ""안에 작성합니다. (학교에서)
           //URL url = new URL("http://192.168.0.42:8081/dbtest/dbdb.jsp");//보낼 jsp 주소를 ""안에 작성합니다. (학교에서)
            //URL url = new URL("http://192.168.123.167:8081/dbtest/dbdb.jsp");//보낼 jsp 주소를 ""안에 작성합니다. (학교에서)
           ...
           // sendMsg = "id="+strings[0]+"&pwd="+strings[1];//보낼 정보인데요. GET방식으로 작성합니다. ex) "id=rain483&pwd=1234";
            ...
            sendMsg ="token="+strings[0]+"&phone="+strings[1]+"&startDate="+strings[2]+"&startTime="+strings[3]+"&count="+strings[4];
    ...
    public String getPhone(){
        TelephonyManager telephone = (TelephonyManager)mContext.getSystemService(TELEPHONY_SERVICE);
