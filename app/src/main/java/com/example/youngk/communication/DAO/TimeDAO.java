...
/**
 * Created by nari on 2017-09-20.
 */

public class TimeDAO extends AsyncTask<String, Void, String> {
    String sendMsg, receiveMsg;
    protected String doInBackground(String... strings) {
        try {
            String str;
            URL url = new URL("http://117.17.142.207:80/dbtest/time.jsp");//보낼 jsp 주소를 ""안에 작성합니다. (학교에서)
